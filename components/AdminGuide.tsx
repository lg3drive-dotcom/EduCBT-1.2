          ...
          <section className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium">
                Satu <b>Token</b> adalah satu paket soal. Contoh: Token <span className="text-blue-600 font-bold">ZXCVB</span> (susunan huruf bebas, bisa juga berisi kombinasi huruf, angka, atau simbol karena tujuannya agar soal yang Anda buat tidak tercampur dengan yang orang lain buat). 

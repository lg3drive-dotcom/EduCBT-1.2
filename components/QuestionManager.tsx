                           ...
                           <div key={idx} className="p-4 bg-slate-50 border rounded-2xl space-y-3 group transition-all hover:border-blue-200 relative">
                              <div className="flex gap-3 items-start">
                                 ...
                                 <div className="flex-1 relative">
                                    ...
                                    }} className="w-full p-3 pr-10 bg-white border rounded-xl text-xs font-mono h-16 outline-none focus:border-blue-500 transition-all" placeholder={`Teks Opsi ${String.fromCharCode(65+idx)}...`} />
                                    <button 
                                      onClick={() => {
